...
<script>
// AI News Feed Configuration
(function() {
  function renderAICard(story, isFeatured) {
  ...
  // Initialize the feed
  new NewsFeed({
    containerId: 'ai-news-feed',
    jsonPath: '/data/ai-police-news.json',
    cardsPerPage: 12,
    filterField: 'story_type',
    filterTypes: ['incident', 'policy', 'vendor', 'research', 'opinion'],
    dateField: 'date_published',
    prefix: 'ai',
    renderCard: renderAICard,
    hasFeatured: false
  });
})();
</script>
