...
[John Shjarback and Natalie Today (2019)](https://doi.org/10.1080/08974454.2018.1520674) use data from the 2013 Law Enforcement Management and Administrative Statistics (LEMAS) survey to analyze correlates of women in supervisory, mid-level, and chief executive roles in 2,826 municipal police, sheriff's offices, and primary state law enforcement agencies. The 2013 LEMAS data was the first national survey to report on this level of data, and **just 2.7% of the agencies were led by women**. My goal here will be to see if using a commercial database of a much larger set of agencies, combined with a probabilistic inference of gender and race, will allow for a more up-to-date estimate than the 2013 LEMAS data allows. 
...
However, in order to constrain the analysis, I will just be looking at Campus Law Enforcement, County Sheriffs, Municipal Law Enforcement, and State Police and Highway Patrol agencies (n=18,064). I'll also reduce this to a simpler dataset by retaining only the department type, first name of administrator, state, and population served.
...
data_sub <- data %>%
  ...
  filter(DeptType == "Municipal Law Enforcement" | 
         ...
         DeptType == "State Police and Highway Patrols") %>% 
...
Many thanks to Jacob Kaplan, who developed the `predictrace` package for R, as this quick analysis wouldn't be possible without his hard work. 
