...
<iframe src="YOUR_SHINYAPPS_URL_HERE" width="100%" height="800px" style="border: 1px solid #ccc; border-radius: 4px;"></iframe>

**Note:** The dashboard may take a moment to load as it downloads and processes the latest data from Mapping Police Violence.

[Click here to open the dashboard in a new window](YOUR_SHINYAPPS_URL_HERE)
...
The complete source code for this dashboard is available in the [project repository](https://github.com/YOUR_USERNAME/mpv-dashboard).
