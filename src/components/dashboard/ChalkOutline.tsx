...
const WOUND_POSITIONS: Record<string, [number, number][]> = {
  ...
  arms: [[55, 100], [145, 100], [50, 120], [150, 120]],
  legs: [[82, 175], [118, 175], [80, 200], [120, 200]],
};
    ...
    <div className="relative w-full max-w-[280px] mx-auto">
      ...
      >
        ...
        >
          ...
          {/* Left arm */}
          <path
            d="M 70 62 Q 55 65 48 80 L 38 110 Q 35 120 32 130 Q 30 135 33 137"
            fill="none" stroke="#d4d0c8" strokeWidth="1.6"
            strokeDasharray="3 1.5" opacity="0.85"
          />

          {/* Right arm */}
          <path
            d="M 130 62 Q 145 65 152 80 L 162 110 Q 165 120 168 130 Q 170 135 167 137"
            fill="none" stroke="#d4d0c8" strokeWidth="1.6"
            strokeDasharray="3 1.5" opacity="0.85"
          />
          ...
          {/* Left leg */}
          <path
            d="M 85 142 L 82 165 Q 80 180 78 200 L 76 225 Q 75 232 70 235 L 65 236"
            fill="none" stroke="#d4d0c8" strokeWidth="1.7"
            strokeDasharray="3 1.5" opacity="0.85"
          />

          {/* Right leg */}
          <path
            d="M 115 142 L 118 165 Q 120 180 122 200 L 124 225 Q 125 232 130 235 L 135 236"
            fill="none" stroke="#d4d0c8" strokeWidth="1.7"
            strokeDasharray="3 1.5" opacity="0.85"
          />
        </g>
