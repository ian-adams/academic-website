...
<script>
// Force Science News Feed Configuration
(function() {
  function renderFSCard(story, isFeatured) {
  ...
  // Initialize the feed
  new NewsFeed({
    containerId: 'force-science-feed',
    jsonPath: '/data/force-science-news.json',
    cardsPerPage: 12,
    filterField: 'story_type',
    filterTypes: ['legal', 'daubert', 'academic', 'policy', 'investigative', 'prosecutorial', 'international', 'opinion'],
    dateField: 'date',
    prefix: 'fs',
    renderCard: renderFSCard,
    hasFeatured: false
  });
})();
</script>
